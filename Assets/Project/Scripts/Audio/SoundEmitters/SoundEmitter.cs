...
public class SoundEmitter : MonoBehaviour
{
	...
	public void FadeMusicIn(AudioClip musicClip, AudioConfigurationSO settings, float duration, float startTime = 0f)
	{
        ...
        _audioSource.volume, settings.Volume, duration).setEase(LeanTweenType.easeOutQuad); //easeOutQuad
	}
	...
	public float FadeMusicOut(float duration)
	{
        ...
        _audioSource.volume, 0f, duration).setEase(LeanTweenType.linear).setOnComplete(OnFadeOutComplete); //easeOutQuad
